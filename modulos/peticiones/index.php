...
<?php
    ...
    if(isset($_GET['notificacion']) && isset($_GET['celular']))
    {
        ...
        $params=array(
            ...
            'to' => '591'.$_GET['celular'],
            'body' => 'Enhorabuena su peticion de joya con IA ha sido aprobada'
            );
            $curl = curl_init();
                            ...
                            <?php if($peticion->estado == 1 || $peticion->estado == 2) { ?>
                                <td class="text-center">
                                    <a name="" id="" class="btn btn-success" href="index.php?notificacion=1&celular=<?php foreach ($usuarios->usuarios as $usuario) {
                                         ...
                                         } ?>" role="button">Notificar al cliente por Whatsapp <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
